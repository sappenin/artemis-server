package org.artemis.server.controllers.spsp;
...
import org.artemis.services.ArtemisIldcpService;
import org.artemis.services.PaymentEndpointsService;
...
/**
 * Services SPSP requests and produces a per-endpoint response.
 *
...
public class SpspController {
    ...
    /**
     * @param paymentEndpointsService
     * @param streamReceiver
     * @param artemisIldcpService
     */
